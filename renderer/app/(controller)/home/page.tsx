  ...
  return (
    <div id={styles.homePage}>
      <div id={styles.mainContent}>
        <h1>Projetos</h1>
        <p>{projects.length > 0 ? 'Selecione um projeto abaixo ou crie um novo :)' : 'Parece que você não tem nenhum projeto. Para começar, aperte o botão abaixo :)'}</p>
        <div id={styles.projects}>
          ...
          <button title='Adicionar/Criar projeto à lista' className={styles.project} onClick={(): void => {
            ((globalThis as any)?.ipc)?.send('app.openDialog', {
